...
public class AllTestCase extends BaseDriver {
    ...
    @Test
    public void US_TEC01_CoursesAtDropDownMenu() {
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains("https://techno.study/tr/data"));

        //delayQuit();
    }

    @Test
    public void US_TEC02_LoginToCampus() {
    ...
    @Test
    public void US_TEC03_ApplyACourse() {
        ...
        Assert.assertTrue(basvurForm.getText().contains("Bize ulaşın!"));
    ...
    @Test
    public void US_TEC04_AccessToCourses() {
        ...
        Assert.assertTrue(sdetSuccess.isEnabled());
        delay(3);
        ...
        Assert.assertTrue(androidSuccess.isEnabled());
        delay(3);
        ...
        Assert.assertTrue(veriBilimiSuccess.isEnabled());
        delay(3);
        ...
        Assert.assertTrue(mastersDrageSuccess.isEnabled());

        //    delayQuit();
    }

    @Test
    public void US_TEC05_AccessSocialMediaAccounts() {
        ...
        for (int i = 0; i < socialMediaList.size(); i++) {
            Assert.assertTrue(socialMediaList.get(i).getAttribute("class").contains(socialMediaSuccess.get(i)));
        }
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains("https://www.instagram.com/techno.study/"));
    ...
    @Test
    public void US_TEC06_ClickLogoForHomePage() {
    ...
    public void US_TEC07() {
        ...
        Assert.assertTrue(icerik1.getText().contains("Program Yapısı"));
        WebElement homePage1 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".t228__imglogo ")));
        Assert.assertTrue(homePage1.isEnabled());
        ...
        Assert.assertTrue(icerik2.getText().contains("Eğitim İçeriği"));
        WebElement homePage2 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".t228__imglogo ")));
        Assert.assertTrue(homePage2.isEnabled());
        WebElement trClick2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Tr'])[1]")));
        trClick2.click();
        ...
        Assert.assertTrue(icerik3.getText().contains("Program Yapısı"));
        WebElement homePage3 = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".t228__imglogo ")));
        Assert.assertTrue(homePage3.isEnabled());
        WebElement trClick3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[text()='Tr'])[1]")));
        trClick3.click();

        Assert.assertTrue(driver.getCurrentUrl().contains("https://techno.study/tr"));
    ...
    public void US_TEC08() {
        ...
        Assert.assertFalse(!driver.getCurrentUrl().contains("https://techno.study/tr"));
    ...
    public void US_TEC09_AccessToTermsOfUsePage() {
        ...
        Assert.assertTrue(form5.isEnabled());
        delay(3);
        ...
        Assert.assertTrue(form6.isEnabled());
